  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/modules/admin/admin.event-workflow.controller.ts',
        'src/modules/admin/admin.event-workflow.service.ts',
        'src/modules/billing/billing.controller.ts',
        'src/modules/billing/billing.repository.ts',
        'src/modules/billing/billing.service.ts',
        'src/modules/citizen/citizen.controller.ts',
        'src/modules/citizen/citizen.repository.ts',
        ...
        'src/modules/events/internal-event-schema-registry.service.ts',
        ...
        'src/modules/events/internal-events.policy.ts',
        ...
        'src/modules/routes/planning.controller.ts',
        'src/modules/routes/planning.repository.ts',
        'src/modules/routes/planning.service.ts',
        'src/modules/monitoring/monitoring.repository.ts',
      ],
      exclude: ['src/tests/**'],
      thresholds: {
        statements: 75,
