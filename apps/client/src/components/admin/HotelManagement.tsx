...
import { HotelCreateModal } from '../components/admin/HotelCreateModal';
...
export function HotelManagement() {
  ...
  const handleCreateHotel = (hotelData) => {
  ...
  const handleUpdateHotel = (hotelData) => {
    updateHotel({ hotelId: editingHotel.id, ...hotelData });
  };
    ...
    <div className="space-y-6">
      ...
      {statsData?.data && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <StatCard
            title="Total Hotels"
            value={statsData.data.total_hotels}
            icon={HotelIcon}
            color="blue"
          />
          <StatCard
            title="Active Hotels"
            value={statsData.data.active_hotels}
            icon={TrendingUp}
            color="green"
          />
          <StatCard
            title="Inactive Hotels"
            value={statsData.data.inactive_hotels}
            icon={ToggleLeft}
            color="yellow"
          />
          <StatCard
            title="With Tickets"
            value={statsData.data.hotels_with_tickets}
            icon={Ticket}
            color="purple"
          />
        </div>
