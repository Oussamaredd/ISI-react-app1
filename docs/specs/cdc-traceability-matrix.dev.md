...
| `UC-A02` Agent validates stop | implemented | `POST /api/tours/:tourId/stops/:stopId/validate` | `api/src/tests/tours-agent-operations.test.ts`, `app/src/tests/e2e.key-journeys.test.tsx` | none |
| `UC-A03` Agent anomaly report | implemented | `POST /api/tours/:tourId/anomalies` | `api/src/tests/tours-agent-operations.test.ts`, `app/src/tests/e2e.key-journeys.test.tsx` | none |
