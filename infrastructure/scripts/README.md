...
- `infrastructure/scripts/ci/run-lighthouse-gate.mjs` builds the app, serves a local preview, and writes Lighthouse reports to `tmp/quality/lighthouse` or `tmp/ci/quality/lighthouse`.
